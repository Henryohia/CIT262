...
var N=(h=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(h,{get:(e,t)=>(typeof require<"u"?require:e)[t]}):h)(function(h){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+h+'" is not supported')});import z from"chalk";import it from"concat-stream";import ae from"lodash";import{loadWASM as rt}from"vscode-oniguruma";import st from"yargs";import{promises as at}from"fs";import ot from"os";import{hideBin as lt}from"yargs/helpers";var K="blade-formatter";var le="1.38.3";import tt from"ignore";import $ from"chalk";import Ee from"find-config";import H from"fs";import nt from"glob";import _ from"lodash";import I from"path";import g from"process";import De from"util";var j=class extends Error{};import{sortClasses as se}from"@shufo/tailwindcss-class-sorter";import Ve from"aigle";import b from"detect-indent";import{sortAttributes as Ce}from"html-attribute-sorter";import E from"js-beautify";import r from"lodash";import*as Qe from"vscode-textmate";import qe from"xregexp";function Ae(h){return h.split(`
...
`)}writeToFile(e,t){this.options.write&&(this.options.checkFormatted||t.length===0||_.isNull(t)||_.isEmpty(t)||H.writeFile(e,t,n=>{n&&(g.stdout.write(`${$.red(n.message)}
